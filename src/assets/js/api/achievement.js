...
const getAchievements = () => {
    return getRequest(`${API_URL}/index.php/achievements/available`);
};

const getFilteredAchievements = (filterData) => {
    return postRequest(`${API_URL}/index.php/achievements/filtered`, filterData);
};

const changeAchievementsStates = (achievementsData) => {
    // TODO: make PUT Request
    return postRequest(`${API_URL}/index.php/achievements/statuses`, achievementsData);
};
